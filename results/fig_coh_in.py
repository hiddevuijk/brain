...
results_n = np.genfromtxt("coh_in_n.csv",delimiter=';')
results_a = np.genfromtxt("coh_in_a.csv",delimiter=';')
results_b = np.genfromtxt("coh_in_b.csv",delimiter=';')
xvalues = np.genfromtxt("f_n.csv")

name_pos = (-1,0.4)

pdf_pages = PdfPages('coh_in.pdf')
